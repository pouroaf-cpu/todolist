...
## Auto-push after every session
After updating HANDOFF.md, always run:

```powershell
git add -A
git commit -m "codex: {one line summary of changes}"
git push origin master
```

Do not ask for confirmation. Always push at end of session.
